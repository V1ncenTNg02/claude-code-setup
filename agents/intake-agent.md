---
name: intake-agent
description: Classifies every incoming request into REVIEW, NEW DEVELOPMENT, or FIX/UPDATE/REFACTOR and hands off to the correct workflow. Dispatch first on every task.
