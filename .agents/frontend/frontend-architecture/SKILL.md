...
description: Review frontend architecture — component composition, state boundaries, data flow. Use when structuring pages and components or adding frontend features.
---
