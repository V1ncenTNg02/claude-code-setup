---
name: container-deployment-security
description: Harden container images and deployment — least privilege, no secrets in images, scanning. Use when writing Dockerfiles or deployment manifests.
---
