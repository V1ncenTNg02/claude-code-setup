...
description: Check database migrations for zero-downtime safety — expand-contract, locking, reversibility. Use when writing or reviewing any schema migration.
---
