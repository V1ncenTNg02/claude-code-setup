...
|---|---|---|
| **REVIEW** | Question, explanation, audit, read-only | `skills/review-workflow` |
| **NEW DEVELOPMENT** | Building something that doesn't exist | `skills/development-workflow` |
| **FIX / UPDATE / REFACTOR** | Changing existing code | `skills/fix-workflow` |
