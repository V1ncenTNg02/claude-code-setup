...
description: Full SDLC workflow for new projects and features — PRD, design, TDD, QA, docs. Use when building something that does not yet exist.
---
...
- Invoke `skills/data-model-design/SKILL.md`
...
- Apply the SQL vs NoSQL decision criteria from `skills/data-model-design/SKILL.md`
...
- Apply `skills/frontend-architecture/SKILL.md`
