...
description: Backend security audit — OWASP, authorization, injection, secrets. Use when reviewing backend code for vulnerabilities or before merging auth, payment, or data changes.
---
