...
description: Review backend architecture for layering, dependency direction, and separation of concerns. Use when adding or restructuring backend services, modules, or data access.
---
