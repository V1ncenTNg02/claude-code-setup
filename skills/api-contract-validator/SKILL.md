...
description: Validate API request/response shape against the design doc before and after implementing an endpoint. Use when adding or changing any HTTP or RPC endpoint.
---
