---
name: deployment
description: Deployment workflow — release steps, rollback, infra checks. Use when the user explicitly requests a deployment.
---
...
- Apply `skills/iac-safety/SKILL.md` before writing any IaC
