...
description: Validate LLM prompt and response contracts — input schema, output format, token budget, safety constraints. Use when adding or changing AI/LLM prompts, tool definitions, or model integrations.
---
