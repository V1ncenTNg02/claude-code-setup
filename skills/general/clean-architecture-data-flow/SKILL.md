---
name: clean-architecture-data-flow
description: Enforce Clean Architecture dependency direction and boundary DTOs. Use when deciding where logic lives or reviewing cross-layer data flow.
---
